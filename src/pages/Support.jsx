...
const Settings = () => {
  ...
  const navigateToGithub = () =>{
    navigate("https://github.com/AminaAdilkhan");
  }
      ...
      <section className="container-fluid width-toggle-5 m-auto">
        ...
        <section className="support-developer d-flex align-items-start justify-content-center w-100 flex-column">
          <p className="py-2 text-muted">
            Few ways you can support my project
          </p>
          ...
          <section className="sponsor-me text-muted text-start">
            <section className="icon-section d-flex p-2">
              ...
              <p className=" text-capitalize px-3 text-dark">Read me!</p>
            </section>
            Hi, I'm Amina Adilkhan. I built this weather app to pass my final
            exams! I hope You like my Web Application. You can give me feedback and 
            estimate my project on my GitHub profile! Thanks!
